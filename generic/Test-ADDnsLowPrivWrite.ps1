...
.PARAMETER DomainNC
  Optional. Explicit domain naming context DN (e.g., 'DC=foo,DC=net').

.PARAMETER Zone
  Optional. FQDN of the forward lookup zone (e.g. foo.net). If omitted, derived from the domain NC.
